...
class GameController:
    ...
    def __init__(self, player_1_id, player_2_id, screen_size: Tuple[int, int], max_score,
                 gravity: float = 1):
        ...
        self.physics_handler = PhysicsHandler(buildings, [player_1, player_2], self._handle_collision, 90, wind,
                                              screen_size)
